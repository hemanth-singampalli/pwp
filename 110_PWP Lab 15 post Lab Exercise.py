...
# Student records
my_record = [
    (92400133094, 's.hemanth', 'PWP', 98),
    (92400133094, 's.hemanth', 'ICE', 95),
    (92400133094, 's.hemanth', 'DMGT', 92),
    (92400133094, 's.hemanth', 'DSC', 89),
    (92400133094, 's.hemanth', 'SS', 86),
    (92400133094, 's.hemanth', 'COA', 84)
]
cursor.executemany('''
...
cursor.execute('''
    UPDATE my_record 
    SET Mark = 98 
    WHERE Enrollment = 92400133110 AND Subject = 'COA'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 92400133110 AND Subject = 'SS'
''')
conn.commit()
